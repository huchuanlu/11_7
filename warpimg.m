...
%% function wimg = warpimg(img, p, sz)
%%extracts the target template
%%Input:
%    img(h,w)   :   original 2D image
%    p(6,n)     :   affine parameters
%    sz(th,tw)  £º  size of target template
%%Output:
%    wimg       :   target template 
